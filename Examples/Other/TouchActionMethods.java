...
public class TouchActionMethods {
	...
	TouchAction touch = new TouchAction(driver);
		...
		// MultiTouchAction:  https://www.udemy.com/appium-selenium-for-mobile-automation-testing/learn/v4/t/lecture/3240376
		...
		// How to long press on an element :like clicking on element : https://www.udemy.com/mobile-automation-using-appiumselenium-3/learn/v4/t/lecture/2016932
			...
			// long press and wait 7 seconds and release only after 7 seconds
			
			touch.longPress(element2).waitAction(7000).release().perform();
